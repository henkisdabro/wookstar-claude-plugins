...
Launch the preview server after creating the HTML file:
...
2. Review the email preview (To, CC, BCC, Subject, Body)
3. Click **"Compose in Gmail"** to open Gmail compose with fields pre-filled and body on clipboard
4. Paste body with Ctrl+V
5. Or use **"Open Gmail Inbox"** / **"Open in Email Client"** as alternatives
...
```
YYYY-MM-DD_recipient_subject.html
...
- `.md` - for reference and version control
- `.html` - for Gmail paste
